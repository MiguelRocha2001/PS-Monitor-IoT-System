...
function getUsersIdsLink(): Link {
    return GET_USERS_IDS_LINK
}
...
function extractGetUsersIdsLink(links: Link[]) {
    return GET_USERS_IDS_LINK = extractLink(links, "users-ids")
}
